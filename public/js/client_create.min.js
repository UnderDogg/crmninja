...
const form_1 = __importDefault(__webpack_require__("./resources/js/src/utils/form.ts"));
// import Toastr
const vue_toastr_1 = __importDefault(__webpack_require__("./node_modules/vue-toastr/dist/vue-toastr.js"));
...
Object.defineProperty(exports, "__esModule", { value: true });
const axios_1 = __importDefault(__webpack_require__("./node_modules/axios/index.js"));
const form_errors_1 = __importDefault(__webpack_require__("./resources/js/src/utils/form-errors.ts"));
class Form {
    /**
    ...
    submit(requestType, url) {
        return new Promise((resolve, reject) => {
            axios_1.default[requestType](url, this.data())
                .then(response => {
